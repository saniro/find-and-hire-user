  ...
  ?>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main style=" background: url(images/me.jpg) no-repeat fixed center;" data-stellar-background-ratio="0.22" role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                <center>
                    <div class="wrapper">
                        <div class="profileContainer">
                            <img class = "profilePicture" src ="<?php echo $profilePic?>" alt = 'Profile Picture'/>
                        </div>
                        <div>
                                                    ...
                                                    if(isset($_POST['saveName'])){
                                                        ...
                                                        if($result){
                                                            echo "<script> 
                                                                    ...
                                                                    window.location.href = 'index?route=customer_profile';
                                                                </script>";
                                                        }else{
                                                            echo "<script> 
